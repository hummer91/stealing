...
async function main() {
	...
	let result_file = `key_match_${process.argv[2]}.csv`;
	let pathfile = balance_path + result_file;
	let WritefileStream = await fs.createWriteStream(pathfile, {
		flags: "a",
		encoding: null,
		mode: 0666,
	...
	let num_list = [
		...
		4294967294, 4292967289,
	];
	let num_1 = num_list[0];
	let num_2 = num_list[1];
	let num_3 = num_list[2];
	let num_4 = num_list[3];
	let num_5 = num_list[4];
	let num_6 = num_list[4];
	let num_7 = num_list[6];
	let num_8 = num_list[7];
	...
	// console.log(result_writeFileStream);
	for (; num_1 >= 0; num_1--) {
						...
						for (; num_6 >= 0; num_6--) {
							...
							for (; num_7 >= 0; num_7--) {
								...
								for (; num_8 >= 0; num_8--) {
									...
									// await console.log(private_8);
									// await console.log(account.address);
									await WritefileStream.write(
										num_1 +
											"," +
											num_2 +
											"," +
